...
MAX_ROWS = 50
ENABLE_SAVE = True
vidName=["Diving", "Rhino", "Roller", "Ny", "Elephant", "Paris"]
fileName=["CoREData_processed2", "FoVData_processed", "FoVPData_processed", "2qlData_processed", "FoV360Data_processed", "FoVP360Data_processed"]

# file_path0 = 'C:/Users/pmija/OneDrive - purdue.edu/lab129/EdgeVR/Code/Video/source/mobisys/allTrace/'+vidName+'/size_processed_core.txt'
# file_path1 = 'C:/Users/pmija/OneDrive - purdue.edu/lab129/EdgeVR/Code/Video/source/mobisys/allTrace/'+vidName+'/size_processed_fovonly.txt'
# file_path2 = 'C:/Users/pmija/OneDrive - purdue.edu/lab129/EdgeVR/Code/Video/source/mobisys/allTrace/'+vidName+'/size_processed_fovp.txt'
# file_path3 = 'C:/Users/pmija/OneDrive - purdue.edu/lab129/EdgeVR/Code/Video/source/mobisys/allTrace/'+vidName+'/size_processed_2ql.txt'
# file_path4 = 'C:/Users/pmija/OneDrive - purdue.edu/lab129/EdgeVR/Code/Video/source/mobisys/allTrace/'+vidName+'/size_processed_fov360.txt'
# file_path5 = 'C:/Users/pmija/OneDrive - purdue.edu/lab129/EdgeVR/Code/Video/source/mobisys/allTrace/'+vidName+'/size_processed_fovp360.txt'
...
def sumAll():
    ...
    for ii in range(len(fileName)):
        ...
        for i in range(len(vidName)):
            file_path0 = "C:/Users/pmija/OneDrive - purdue.edu/lab129/EdgeVR/Code/Video/source/mobisys/allTrace/" + vidName[i] + "/"
            file_path1=file_path0+fileName[ii]+".txt"
            print(file_path1)
            with open(file_path1) as fp:
                data = fp.read()
                data2+=data
                print(data)
        fp="C:/Users/pmija/OneDrive - purdue.edu/lab129/EdgeVR/Code/Video/source/mobisys/allTrace/combine/"+fileName[ii]+".txt"
        print(fp)
        with open(fp,'w') as fpw:
            fpw.write(data2)
...
def sumAnB(fileA,fileB, name,pathsave):
    ...
    print(len(df_tempA),len(df_tempB), len(df_tempC))
    temp3=np.zeros(len(df_tempC))
    for a in range(len(df_tempC)):
